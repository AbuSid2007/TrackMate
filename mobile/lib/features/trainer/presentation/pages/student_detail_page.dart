                ...
                children: [
                  Row(
                    children: [
                      ...
                      _topStat('Streak',
                          '${(_stats['streak_days'] ?? 0)} days'),
                      const SizedBox(width: 12),
                      _topStat('Workouts',
                          '${(_stats['weekly']?['workouts_completed'] ?? 0)}/wk'),
                    ],
                  ),
...
class _HistoryTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final steps = stats['steps_history'] as List? ?? [];
    ...
    return ListView(
      ...
      children: [
        ListTile(
          ...
          title: const Text('Workouts this week'),
          trailing: Text('${weekly['workouts_completed'] ?? 0}',
              style: const TextStyle(fontWeight: FontWeight.bold)),
        ),
        ListTile(
          ...
          trailing: Text(
              '${(weekly['calories_burned'] ?? 0).toStringAsFixed(0)} kcal',
              style: const TextStyle(fontWeight: FontWeight.bold)),
        ),
        ListTile(
          leading: const Icon(Icons.directions_walk, color: AppColors.success),
          title: const Text('Total steps'),
          trailing: Text('${weekly['total_steps'] ?? 0}',
              style: const TextStyle(fontWeight: FontWeight.bold)),
        ),
        ListTile(
          leading: const Icon(Icons.star, color: Colors.amber),
          title: const Text('Streak'),
          trailing: Text('${stats['streak_days'] ?? 0} days',
              style: const TextStyle(fontWeight: FontWeight.bold)),
        ),
      ],
    );
